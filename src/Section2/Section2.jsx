...
export const Section2 = () => {
  ...
  return (
    <>
      <section className={`${ModeChanger("","bg-black text-white")}`}>
          ...
          <div className="rounded-lg border bg-card text-card-foreground shadow-sm hover:bg-secondary cursor-default transition-all ease-in-out duration-200">
            <div className="flex flex-col space-y-1.5 p-6 text-center items-center gap-2">
              <img
                ...
                src="https://42.uz/_next/image?url=%2Fauthors%2Fazimjon.jpg&w=128&q=75"
              />
            ...
            <div className="p-6 pt-0 flex flex-col items-center justify-center gap-6">
              <img
                className="h-8 object-contain dark:bg-slate-100 dark:p-1 dark:rounded-md"
